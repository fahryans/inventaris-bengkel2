                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="role" id="role" class="form-select @error('role') is-invalid @enderror" required>
                                ...
                                <option value="kadep" {{ old('role') == 'kadep' ? 'selected' : '' }}>Kepala Departemen</option>
                                <option value="kepala_labor" {{ old('role') == 'kepala_labor' ? 'selected' : '' }}>Kepala Laboratorium</option>
